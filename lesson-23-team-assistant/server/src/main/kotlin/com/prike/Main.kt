...
fun main(args: Array<String>) {
    ...
    logger.info("Starting lesson-23-team-assistant server...")
    ...
    embeddedServer(Netty, port = config.server.port, host = config.server.host) {
        ...
        routing {
            ...
            // Health check API
            get("/api/health") {
                call.respond(HttpStatusCode.OK, HealthResponse("ok", "lesson-23-team-assistant-server"))
            }
...
/**
 * Находит корень урока (lesson-23-team-assistant)
 */
