...
group = "com.prike.taskmcpserver"
version = "1.0.0"

application {
    mainClass.set("com.prike.taskmcpserver.MainKt")
}
...
tasks.jar {
    archiveBaseName.set("task-mcp-server")
    manifest {
        attributes["Main-Class"] = "com.prike.taskmcpserver.MainKt"
    }
