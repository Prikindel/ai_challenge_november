...
object Config {
    ...
    /**
     * Находит корень проекта (lesson-17-rag-reranking)
     */
    ...
    private fun findConfigDirectory(): String {
        ...
        // Ищем lesson-17-rag-reranking вверх по дереву
        var searchDir = currentDir
        while (searchDir != null && searchDir.parentFile != null) {
            if (searchDir.name == "lesson-17-rag-reranking") {
            ...
            val lessonDir = File(searchDir, "lesson-17-rag-reranking")
            if (lessonDir.exists()) {
        ...
        throw IllegalStateException(
            ...
            "Please ensure config/server.yaml exists in lesson-17-rag-reranking directory."
        )
    }
}
