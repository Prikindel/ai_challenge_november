    ...
    companion object {
        ...
        private fun getSystemPrompt(): String {
            return """
                ...
                - КРИТИЧЕСКИ ВАЖНО: Все строковые значения в JSON должны быть правильно экранированы
                - Если в строке есть примеры кода с кавычками, используй одинарные кавычки для примеров: File('test.txt') вместо File("test.txt")
                - Или экранируй двойные кавычки: File(\"test.txt\")
