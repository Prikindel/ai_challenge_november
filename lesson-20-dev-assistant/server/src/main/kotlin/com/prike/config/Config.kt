...
object Config {
    ...
    /**
     * Находит корень проекта (lesson-20-dev-assistant)
     */
    ...
    private fun findConfigDirectory(): String {
        ...
        // Ищем lesson-20-dev-assistant вверх по дереву
        var searchDir = currentDir
        while (searchDir != null && searchDir.parentFile != null) {
            if (searchDir.name == "lesson-20-dev-assistant") {
            ...
            val lessonDir = File(searchDir, "lesson-20-dev-assistant")
            if (lessonDir.exists()) {
        ...
        throw IllegalStateException(
            ...
            "Please ensure config/server.yaml exists in lesson-20-dev-assistant directory."
        )
    }
}
