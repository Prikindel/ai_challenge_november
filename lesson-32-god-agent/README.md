...
- **📺 Видео демонстрация**: [Смотреть на Яндекс Диске](https://disk.yandex.ru/i/RG2-4bPE6gDrCQ)
- **📂 Исходный код**: [GitHub репозиторий](https://github.com/Prikindel/ai_challenge_november/tree/main/lesson-32-god-agent)
...
```bash
git clone https://github.com/Prikindel/ai_challenge_november.git
cd ai_challenge_november/lesson-32-god-agent
```
...
- `Покажи последние 5 коммитов в git репозитории`
- `Прочитай файл README.md из репозитория`

#### Telegram MCP
- `Отправь сообщение в Telegram: Привет! Это тестовое сообщение от God Agent`

#### Calendar MCP
- `Создай событие в календаре: название "Встреча с командой", начало "2024-12-20T15:00:00", категория "работа"`
- `Покажи все события в календаре на сегодня`
- `Какие события запланированы на ближайшие 7 дней?`

#### File System MCP
- `Прочитай файл README.md из директории lesson-32-god-agent`
- `Найди все файлы с расширением .kt в директории server/src`

#### Knowledge Base (RAG)
- `Найди информацию о MCP протоколе в базе знаний`
- `Что такое RAG?`
- `Расскажи о проекте X`

#### Analytics MCP
- `Проанализируй данные из источника Metrics`
- `Покажи статистику из CSV файла`
