...
- [lesson-21-code-review](./lesson-21-code-review/) — автоматизация ревью кода: RAG для документации проекта, MCP для получения diff из PR, автоматическое ревью с замечаниями и предложениями
